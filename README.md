...
홍보센터의 타이틀 텍스트인 '뉴스'를 다른 페이지의 타이틀 텍스트와 동일한 폰트 사이즈로 수정함 </br>
연구정보의 타이틀 텍스트를 회사소개의 타이틀 텍스트와 동일한 구조로 수정하여 통일감을 향상시킴 </br>
특허증과 특허증 닫기 버튼에 호버 애니메이션 효과를 적용함 </br>
</br>
</br>
수정할 예정 : 특허증이 자동으로 슬라이드 되지 않고 버튼으로 볼 수 있도록 수정할 예정
